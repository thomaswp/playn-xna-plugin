...
public class XnaPluginMojo extends AbstractMojo
{
     ...
     * @parameter expression="${xna.qualifiedGameName}"
     */
     ...
     * @parameter expression="${xna.spritefonts}"
     */
    public String[] spritefonts;
    
    /**
     * Tells the plugin whether to overwrite the solution (.sln) file if it already exists. Defaults to false.
     * @parameter expression="${xna.overwriteSln}" default-value="false"
     */
    public boolean overwriteSLN;
    
    /**
     * Tells the plugin whether to overwrite the project (.csproj) file if it already exists. Defaults to false.
     * @parameter expression="${xna.overwriteProject}" default-value="false"
     */
    public boolean overwriteProject;
    
    /**
     * Tells the plugin whether to overwrite the game entry point (.cs) file if it already exists. 
     * Defaults to false.
     * @parameter expression="${xna.overwriteGame}" default-value="false"
     */
    public boolean overwriteGame;
    
    /**
     * Tells the plugin whether to overwrite the contenet project (.contentproj) file if it already exists. 
     * Defaults to true.
     * @parameter expression="${xna.overwriteContent}" default-value="true"
     */
    public boolean overwriteContent;
    
    /**
     * Tells the plugin whether to overwrite the Importer.cs file if it already exists. Defaults to true.
     * @parameter expression="${xna.overwriteImporter}" default-value="true"
     */
    public boolean overwriteImporter;
